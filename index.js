...
model_entrada.create({titulo:"Contabilidad",descripcion: "Asesoría contable ",detalle:"Estados Financieros"},
function(err){
...
model_usuario.create({nombre:"Cristina",apellidos:"Rojas",email: "crisrojas@gmail.com"},
function(err){
    if(err)return console.error(err);
}
);